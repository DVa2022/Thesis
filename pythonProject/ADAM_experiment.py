...
def main():
    ...
    for i in range(0, 8):
        ...
        optimizer_name = 'AdamW' if i % 2 == 0 else 'Adamax'

        if experiment_name == 'base':
            experiment_name = experiment_name + '_' + optimizer_name + '_experiment_' + str(i)
        else:
            experiment_name = 'base_' + optimizer_name + '_experiment_' + str(i)
        ...
        if i % 2 == 0:
            ...
            optimizer = torch.optim.Adamax(params, lr=0.001, weight_decay=0.0005)
