...
def main():
    ...
    if 'my_runs' not in os.listdir(os.getcwd()):
        os.mkdir('my_runs')
    experiment_dir = '/home/stu16/PycharmProjects/pythonProject/my_runs/Faster_RCNN_' + datetime.datetime.now().strftime('%Y%m%d_%H%M%S') + '_' + experiment_name
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        train_one_epoch(model, optimizer, train_loader, device, epoch, print_freq=200, scaler=None)
