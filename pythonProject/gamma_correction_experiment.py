...
class myOwnDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if random.random() < 0.35:
            img = torchvision.transforms.functional.adjust_gamma(img, gamma=random.randint(400, 1200) / 1000)
...
def main():
    ...
    for i in range(0, 10):
        ...
        if experiment_name == 'base':
            experiment_name = experiment_name + '_gamma_correction_experiment_' + str(i)
        else:
            experiment_name = 'base' + '_gamma_correction_experiment_' + str(i)
