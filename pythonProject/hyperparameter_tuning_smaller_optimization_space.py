...
def main():
    ...
    for i in range(6, 9):
        ...
        random_random_equalize_probability_options = [0, 0.1, 0.15, 0.35, 0.5]
        best_random_equalize_probability = -1
        best_random_equalize_probability_performance = -1

        if experiment_name == 'base':
            experiment_name = experiment_name + '_transformations_tuning_smaller_optimization_space' + str(i)
        else:
            experiment_name = 'base' + '_transformations_tuning_smaller_optimization_space' + str(i)
            ...
            for epoch in tqdm(range(num_epochs)):
                ...
                if mAP > best_mAP:
                    ...
                    if early_stopping_counter == max_epochs_without_improvement:
                        ...
                        if best_mAP > best_random_equalize_probability_performance:
