...
def main():
    ...
    current_ds = os.listdir('/workspace/PycharmProjects/pythonProject/datasets/train3/labels')
    ...
    for file in current_ds:
        if 'hashed' in file and file not in original_ds:
            os.remove('/workspace/PycharmProjects/pythonProject/datasets/train3/labels/' + file)
            os.remove('/workspace/PycharmProjects/pythonProject/datasets/train3/images/' + file.replace('txt', 'jpg'))
    ...
    for max_num_of_frames_from_each_vid in max_num_of_frames_from_each_vid_options:
        ...
        experiment_name = 'semi-supervised_XL_model_training-series3_' + str(max_num_of_frames_from_each_vid) + '-fold_increase_with_unannotated_data_'
        num_epochs = 55
        ...
        if len(os.listdir('/workspace/PycharmProjects/pythonProject/datasets/train3/labels')) < 10:  # if the folder is empty, it should be filled with data. It happens when max_num_of_frames_from_each_vid==1
        ...
        semi_supervised_data_leakage_check('3')
        
        num_of_samples = len(os.listdir('/workspace/PycharmProjects/pythonProject/datasets/train3/labels'))
        ...
        for i in range(1):
            ...
            results = model.train(data='/workspace/PycharmProjects/pythonProject/datasets/data3.yaml', epochs=num_epochs, imgsz=640,
