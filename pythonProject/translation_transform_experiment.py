...
class myOwnDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            print("here")
            img = v2.Normalize((mean), (0.001))(tensor_img)
    ...
    for i in range(0, 8):
        for translation_val in translation_vals:
            transforms_train = v2.Compose([
                ...
                v2.RandomAffine(translate=(0.1, translation_val), degrees=0)
            ])
            ...
            if experiment_name == 'base':
                experiment_name = experiment_name + '_translation_experiment_value=' + str(translation_val) + '_' + str(i)
            else:
                experiment_name = 'base' + '_translation_experiment_value=' + str(translation_val) + '_' + str(i)
